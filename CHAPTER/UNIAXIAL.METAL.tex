...
\begin{gather}
\eta=\sigma-z\alpha+\left(z-1\right)\left(d+\alpha\right)=\sigma-\alpha+\left(z-1\right)\sigma^yd.
\end{gather}
...
\toprule
Constitutive Law&$\sigma=E\left(\varepsilon-\varepsilon^p\right)$\\
Subloading Surface&$f_s=\abs{\eta}-z\sigma^y=\abs{\sigma-\alpha+\left(z-1\right)\sigma^yd}-z\sigma^y$\\
...
\mb{R}=\left\{
\begin{array}{l}
\abs{\sigma-\alpha+\left(z-1\right)\sigma^yd}-z\sigma^y,\\[2mm]
z-z_n-U\gamma.
\end{array}
\right.
\end{gather}
...
\begin{gather}
\mb{J}=\begin{bmatrix}
n\left(-En-\ddfrac{\alpha}{\gamma}+\left(z-1\right)\left(\ddfrac{d}{\gamma}\sigma^y+\ddfrac{\sigma^y}{\gamma}d\right)\right)-z\ddfrac{\sigma^y}{\gamma}&n\sigma^yd-\sigma^y\\[2mm]
...
\begin{gather}
\eta=\sigma^\text{trial}-E\gamma{}n-\dfrac{b\gamma{}a^yn+\alpha_n}{1+b\gamma}+\left(z-1\right)\sigma^y\dfrac{c_ez_e\gamma{}n+d_n}{1+c_e\gamma},
\end{gather}
by rearranging all $\eta$ related terms (including $n$) to the left, one can obtain
\begin{gather}
\eta+E\gamma{}n+\dfrac{b\gamma{}a^yn}{1+b\gamma}+\left(1-z\right)\dfrac{c_ez_e\gamma{}\sigma^yn}{1+c_e\gamma}=\sigma^\text{trial}-\dfrac{\alpha_n}{1+b\gamma}+\left(z-1\right)\dfrac{\sigma^yd_n}{1+c_e\gamma},
\end{gather}
this is effectively
\begin{gather}
\left(\abs{\eta}+E\gamma{}+\dfrac{b\gamma{}a^y}{1+b\gamma}+\left(1-z\right)\dfrac{c_ez_e\gamma{}\sigma^y}{1+c_e\gamma}\right)n=\sigma^\text{trial}-\dfrac{\alpha_n}{1+b\gamma}+\left(z-1\right)\dfrac{\sigma^yd_n}{1+c_e\gamma}.
\end{gather}
Noting that $\gamma>0$, $a^y>0$, $\sigma^y>0$ and by definition, $1-z>0$, the big bracket is in fact non-negative. This means,
\begin{gather}
n=\sign{\sigma^\text{trial}-\dfrac{\alpha_n}{1+b\gamma}+\left(z-1\right)\dfrac{\sigma^yd_n}{1+c_e\gamma}},
\end{gather}
...
\EndWhile
\State \If{$\gamma>0$}\Comment{plastic}
