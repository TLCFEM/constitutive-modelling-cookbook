...
\dot{\bvarepsilon^p}=\gamma\pdfrac{f}{\bsigma}=\gamma\dfrac{\beeta}{\norm{\beeta}}=\gamma\bn.
\end{gather}
...
\dot{\balpha}=b\left(a^y\dot{\bvarepsilon^p}-\balpha\dot{q}\right),\\
\dot{\bd}=c_e\left(z_e\sigma^y\dot{\bvarepsilon^p}-\bd\dot{q}\right).
\end{gather}
