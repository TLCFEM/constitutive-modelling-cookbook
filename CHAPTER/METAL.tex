...
We have prepared all necessary ingredients to compute the full derivatives of (the summation term of) the yield function.
\begin{gather}
    \begin{split}
...
\begin{gather}
    \pdfrac{\bu}{\bs}=\pdfrac{\bu}{\bn}:\pdfrac{\bn}{\bs}=\dfrac{1}{\norm{\bn}}\left(\mathbb{I}-\bu\otimes\bu\right):\mathbb{I}_\text{dev}:\pdfrac{^2f}{\bs^2}=\dfrac{1}{\norm{\bn}}\left(\mathbb{I}_\text{dev}-\bu\otimes\bu\right):\pdfrac{^2f}{\bs^2}.
\end{gather}
...
\begin{gather}
    \mb{J}=\underbrace{\begin{bmatrix}
            ...
            \mb{E}\bn                                                     & \mb{I}+\gamma\mb{E}\mathbb{I}_\text{dev}:\pdfrac{^2f}{\bs^2} & -\gamma\mb{E}\mathbb{I}_\text{dev}:\pdfrac{^2f}{\bs^2}                            \\[4mm]
