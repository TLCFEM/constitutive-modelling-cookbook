...
\begin{gather}
    \pdfrac{\bn}{\bvarepsilon}=\dfrac{2G}{\norm{\bzeta}}\left(\mathbb{I}^\text{dev}-\bn\bn^\mT\right),
\end{gather}
...
\begin{gather}
    \pdfrac{\bu}{\bs}=\pdfrac{\bu}{\bn}:\pdfrac{\bn}{\bs}=\dfrac{1}{\norm{\bn}}\left(\mathbb{I}-\bu\otimes\bu\right):\mathbb{I}^\text{dev}:\pdfrac{^2f}{\bs^2}=\dfrac{1}{\norm{\bn}}\left(\mathbb{I}^\text{dev}-\bu\otimes\bu\right):\pdfrac{^2f}{\bs^2}.
\end{gather}
