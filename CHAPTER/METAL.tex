...
\end{gather}
noting now $\beeta=\dev{\bsigma}-\balpha+\left(z-1\right)\bd$.
\subsubsection{Flow Rule}
...
\begin{gather}
    \beeta=\bs^\text{trial}-\gamma2G\bn-\dfrac{\gamma{}ba^y\bn+\balpha_n}{1+\sqrt{\dfrac{2}{3}}\gamma{}b}+\left(z-1\right)\dfrac{\gamma{}c_ez_e\sigma^y\bn+\bd_n}{1+\sqrt{\dfrac{2}{3}}\gamma{}c_e}.
\end{gather}
Rearranging gives
\begin{multline}
    \beeta+\gamma2G\bn+\dfrac{\gamma{}ba^y\bn}{1+\sqrt{\dfrac{2}{3}}\gamma{}b}+\left(1-z\right)\dfrac{\gamma{}c_ez_e\sigma^y\bn}{1+\sqrt{\dfrac{2}{3}}\gamma{}c_e}\\=\bs^\text{trial}-\dfrac{\balpha_n}{1+\sqrt{\dfrac{2}{3}}\gamma{}b}+\left(z-1\right)\dfrac{\bd_n}{1+\sqrt{\dfrac{2}{3}}\gamma{}c_e}.
\end{multline}
Let's denote
\begin{gather}
    \bzeta=\bs^\text{trial}-\dfrac{\balpha_n}{1+\sqrt{\dfrac{2}{3}}\gamma{}b}+\left(z-1\right)\dfrac{\bd_n}{1+\sqrt{\dfrac{2}{3}}\gamma{}c_e}.
\end{gather}
...
so that
\begin{gather}
\pdfrac{\norm{\beeta}}{\gamma}=\bn:\pdfrac{\bzeta}{\gamma}-2G-\pdfrac{}{\gamma}\left(\dfrac{\gamma{}ba^y}{1+\sqrt{\dfrac{2}{3}}\gamma{}b}+\left(1-z\right)\dfrac{\gamma{}c_ez_e\sigma^y}{1+\sqrt{\dfrac{2}{3}}\gamma{}c_e}\right),\\
\pdfrac{\norm{\beeta}}{z}=\bn:\pdfrac{\bzeta}{z}+\dfrac{\gamma{}c_ez_e\sigma^y}{1+\sqrt{\dfrac{2}{3}}\gamma{}c_e}.
\end{gather}
