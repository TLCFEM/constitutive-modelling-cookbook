...
\end{gather}
noting now $\beeta=\dev{\bsigma}-\balpha+\left(z-1\right)\sigma^y\bd$.
\subsubsection{Flow Rule}
...
\dot{\balpha}=b\left(\sqrt{\dfrac{2}{3}}a^y\bn-\balpha\right)\gamma,\\
...
\begin{gather}
    \balpha=\dfrac{\gamma{}\sqrt{\dfrac{2}{3}}ba^y\bn+\balpha_n}{1+\gamma{}b},\qquad
    \bd=\dfrac{\gamma{}\sqrt{\dfrac{2}{3}}c_ez_e\bn+\bd_n}{1+\gamma{}c_e}.
\end{gather}

The shifted stress is then
\begin{gather}
    \beeta=\bs^\text{trial}-\gamma2G\bn-\dfrac{\gamma{}\sqrt{\dfrac{2}{3}}ba^y\bn+\balpha_n}{1+\gamma{}b}+\left(z-1\right)\sigma^y\dfrac{\gamma{}\sqrt{\dfrac{2}{3}}c_ez_e\bn+\bd_n}{1+\gamma{}c_e}.
\end{gather}
Rearranging gives
\begin{multline}
    \beeta+\gamma2G\bn+\dfrac{\gamma{}\sqrt{\dfrac{2}{3}}ba^y\bn}{1+\gamma{}b}+\left(1-z\right)\sigma^y\dfrac{\gamma{}\sqrt{\dfrac{2}{3}}c_ez_e\bn}{1+\gamma{}c_e}=\\\bs^\text{trial}-\dfrac{\balpha_n}{1+\gamma{}b}+\left(z-1\right)\sigma^y\dfrac{\bd_n}{1+\gamma{}c_e}.
\end{multline}
Let's denote
\begin{gather}
    \bzeta=\bs^\text{trial}-\dfrac{\balpha_n}{1+\gamma{}b}+\left(z-1\right)\sigma^y\dfrac{\bd_n}{1+\gamma{}c_e}.
\end{gather}
Since $\bn=\dfrac{\beeta}{\norm{\beeta}}$, one could conclude that
\begin{gather}
    \norm{\beeta}+\gamma2G+\dfrac{\gamma{}\sqrt{\dfrac{2}{3}}ba^y}{1+\gamma{}b}+\left(1-z\right)\sigma^y\dfrac{\gamma{}\sqrt{\dfrac{2}{3}}c_ez_e}{1+\gamma{}c_e}=\norm{\bzeta},
\end{gather}
and
\begin{gather}
...
\begin{gather}
    \pdfrac{\bzeta}{\gamma}=\dfrac{b}{\left(1+b\gamma\right)^2}\balpha_n+\left(z-1\right)\dfrac{\ddfrac{\sigma^y}{\gamma}\left(1+c_e\gamma\right)-c_e\sigma^y}{\left(1+c_e\gamma\right)^2}\bd_n,\qquad
    \pdfrac{\bzeta}{z}=\dfrac{\sigma^y}{1+c_e\gamma}\bd_n.
\end{gather}
...
In which,
\begin{gather}
\pdfrac{\norm{\beeta}}{\gamma}=\pdfrac{\norm{\bzeta}}{\gamma}-2G-\pdfrac{}{\gamma}\left(\dfrac{\gamma{}\sqrt{\dfrac{2}{3}}ba^y}{1+\gamma{}b}+\left(1-z\right)\sigma^y\dfrac{\gamma{}\sqrt{\dfrac{2}{3}}c_ez_e}{1+\gamma{}c_e}\right),\\
\pdfrac{\norm{\beeta}}{z}=\pdfrac{\norm{\bzeta}}{z}+\sigma^y\dfrac{\gamma{}\sqrt{\dfrac{2}{3}}c_ez_e}{1+\gamma{}c_e}.
\end{gather}
...
so that
\begin{gather}
\pdfrac{\norm{\beeta}}{\gamma}=\bn:\pdfrac{\bzeta}{\gamma}-2G-\pdfrac{}{\gamma}\left(\dfrac{\gamma{}\sqrt{\dfrac{2}{3}}ba^y}{1+\gamma{}b}+\left(1-z\right)\sigma^y\dfrac{\gamma{}\sqrt{\dfrac{2}{3}}c_ez_e}{1+\gamma{}c_e}\right),\\
\pdfrac{\norm{\beeta}}{z}=\bn:\pdfrac{\bzeta}{z}+\sigma^y\dfrac{\gamma{}\sqrt{\dfrac{2}{3}}c_ez_e}{1+\gamma{}c_e}.
\end{gather}
\subsection{Implementation}
\begin{cppcode}
