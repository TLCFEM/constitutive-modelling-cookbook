...
Due to the presence of double contraction, it is clearly a tensor operation.
If expressed in the Voigt notation, the additional scaling matrix $\mb{S}$ is required.

Now we proceed to compute the derivative of $\mb{n}$ with respect to $\mb{\sigma}$.
\begin{gather}
\ddfrac{\mb{n}}{\mb{\sigma}}
=\dfrac{\ddfrac{\mb{\sigma}}{\mb{\sigma}}\norm{\mb{\sigma}}-\mb{\sigma}\otimes\ddfrac{\norm{\mb{\sigma}}}{\mb{\sigma}}}{\norm{\mb{\sigma}}^2}
