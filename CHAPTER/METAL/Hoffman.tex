...
As a matter of fact, the von Mises model can be seen as a degenerate version of the Hoffman model.
...
Unlike other models introduced in this book, because the yield function is expressed in matrix form, all the following are thus mainly based on matrix notation.
