...
\end{gather}
One would find this coincides with the associative plasticity (the second equality).
...
We avoid such a complex presentation as it may cause unnecessary confusion. At its core, the crack closing mechanism tries to close the unclosed crack ($k_t-k_k$) by accumulating a portion of strain increment to $k_k$ ($\Delta{}k_k=\abs{\Delta\varepsilon}\dfrac{E}{E+h_k}$), and this mechanism is conditionally activated.
