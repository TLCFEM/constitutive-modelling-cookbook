...
In this chapter, we discuss some miscellaneous topics that are relevant to numerical implementations of constitutive models.
...
It easily leads to precision issues, especially when the local nonlinear system also contains some nondimensional history variables.
...
Now, let's consider integrating this ODE using the first--order backward Euler method and the second--order Trapezoidal method.
\begin{figure}[ht]
    \centering
