...
This book aims to provide a practical guide to numerical implementations of plasticity models.
...
The ultimate target is to provide an easy-to-follow, error-free reference for readers who are interested in implementing constitutive models under the modern conventional and novel plasticity framework.
...
There are a huge number of symbols and formulae.

As the title indicates, this book is drafted as a reference book on constitutive modelling, it shall be self-contained in terms of the theoretical part.
...
For finite element analysis, nodes/elements can be perfectly modelled as objects, thus object--oriented programming (OOP) is a natural choice.
\end{itemize}

In this book, \texttt{C++} is chosen as the implementation language.
It may not be the perfect choice for everyone (subject to personal preference), but it is definitely a reasonable choice.
