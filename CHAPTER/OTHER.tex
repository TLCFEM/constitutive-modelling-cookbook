...
We present a Gurson's void growth model.
...
\end{gather}
where $\sigma_y$ is a function of the equivalent plastic strain $\varepsilon^p_m$, $f$ is the void volume fraction, the remaining $q_1$, $q_2$ and $q_3=q_1^2$ are material constants \cite{Tvergaard1982}.
In addition,
\begin{gather}
